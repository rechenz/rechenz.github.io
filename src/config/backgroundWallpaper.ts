...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/silverwolf.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/silverwolf.jpg",
		],
		// 背景视频播放地址
		...
		// 原先指向模板作者的视频床，已移除；
		// 要开视频就把自己的视频放到 public/assets/videos/，填路径并把上面的 playerEnable 改回 true
		playerUrl: "",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
			...
			links: [
				{
					...
					url: "https://github.com/rechenz",
					showName: true,
				},
				{
					name: "Email",
					icon: "fa7-solid:envelope",
					url: "mailto:13244571368@qq.com",
				},
				{
					name: "RSS",
					icon: "fa7-solid:rss",
