...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "游戏开发者 · AI 爱好者",

	// 站点 URL
	site_url: "https://rechenz.github.io",

	// 站点描述
	description:
		"游戏、代码、胡思乱想。游戏开发者 / AI 爱好者，折腾 UE5、AI Agent 与算法竞赛。",
	...
	navbar: {
		...
		logo: {
			type: "icon",
			value: "material-symbols:code-blocks-outline",
		},
		// 导航栏标题
		title: "热尘的博客",
		// 全宽导航栏，导航栏是否占满屏幕宽度
